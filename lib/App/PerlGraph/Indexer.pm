...
use constant EXTRACTION_VERSION => 16;  # 16: quote-aware arg split + conventional-name invocant guard; 15: inter-procedural taint (sink_params/taint_out) for verified cross-sub value-flow
